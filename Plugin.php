...
/**
 *  修复bug，提供给Typecho用户使用的插件。<br>实现网站静态资源存储到腾讯云COS，有效降低本地存储负载，提升用户体验。
 *
 * @package 腾讯云对象存储（COS）插件
 * @author susu
 * @version 1.0.5
 * @link https://github.com/lww334455/TypechoPluginCos
 * @dependence 1.1.2-*
 * @date 2022-08-08
 * @update 2025-07-25
 */
...
?>
    ...
    <div class="joe_config">
      ...
      <div class="joe_config__notice">
        ...
        <ol>
          ...
          <li>插件基于腾讯云cos-php-sdk-v5开发，若发现插件不可用，请到 <a target="_blank" href="https://github.com/lww334455/TypechoPluginCos">GitHub发布地址</a> 检查是否有更新，或者提交Issues<br></li>
  ...
  public static function CosInit($options = '')
  {
    ...
    return new \Qcloud\Cos\Client(array(
      ...
      'domain' => isset($options->domain) ? preg_replace('#^https?://#', '', rtrim($options->domain, '/')) : null,
      'credentials' => array(
